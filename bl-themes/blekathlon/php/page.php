	...
	<main class="site-content" role="main">
		<article class="hentry">
			...
			<header class="entry-header page-header text-center">
				...
				<a href="<?php echo HTML_PATH_ADMIN_ROOT.'edit-content/'.$page->permalink(false) ?>" target="_blank">
			...
			<div class="entry-media post-thumbnail post-thumbnail-singular">
				<img src="<?php echo $page->coverImage() ?>" alt="<?php echo $page->title() ?>"
					<?php echo $helper->generate_srcset( $page->coverImage()) ?> />
			</div>
			<?php endif ?>
			...
			<div class="related-items">
				...
				<div class="rel-item">
					...
					<div class="rel-item__icon">
						<img src="<?php echo $helper->resize_image($relpage['image'] ,"resize=60%2C60") ?>" />
					</div>
