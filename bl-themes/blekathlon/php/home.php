...
<div class="content-area site-content main-padding">
	<main class="site-main main-width blog-wrapper" role="main">
		<header class="page-header">
			...
			<!-- Site title -->
			<h1 class="page-title no-margin-bottom text-center text-italic">
				<?php echo $site->slogan(); ?>
			</h1>
			<?php if ($site->description()): ?>
			<p class="site-description no-margin-bottom text-center text-italic">
		...
		<article class="home-page hentry">
			<?php $coverImage = $helper->resize_first_image("resize=350%2C350");?>
